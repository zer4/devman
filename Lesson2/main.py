...
print(num2words(78), '-', translit(num2words(78), 'ru'))
print(num2words(15), '-', translit(num2words(15), 'ru'))
print(num2words(3), '-', translit(num2words(3), 'ru'))
print(num2words(40), '-', translit(num2words(40), 'ru'))
print(num2words(8), '-', translit(num2words(8), 'ru'))